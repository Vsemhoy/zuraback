...
Route::prefix('api')->middleware(['spa.request', 'auth', 'active'])->group(function (): void {
    ...
    Route::prefix('/scopes/{scope}')->middleware('scope.member')->group(function (): void {
        ...
        Route::get('/lore/context', [LoreController::class, 'context'])->middleware(['scope.actor', 'scope.ability:task.view']);
        Route::get('/lore/areas', [LoreController::class, 'areas'])->middleware(['scope.actor', 'scope.ability:task.view']);
        Route::post('/lore/areas', [LoreController::class, 'storeArea'])->middleware(['scope.actor', 'scope.ability:task.update']);
        Route::get('/lore/tags', [LoreController::class, 'tags'])->middleware(['scope.actor', 'scope.ability:task.view']);
        Route::get('/lore', [LoreController::class, 'index'])->middleware(['scope.actor', 'scope.ability:task.view']);
